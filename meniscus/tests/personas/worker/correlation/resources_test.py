...
import meniscus.personas.worker.correlation.correlation_process as process
from meniscus.personas.worker.correlation.resources \
    import PublishMessageResource
from meniscus.personas.worker.correlation.resources import VersionResource
...
class WhenTestingPublishMessage(unittest.TestCase):
    ...
    def test_validate_body_throws_validation_error(self):
        with patch('meniscus.personas.worker.correlation.resources.'
